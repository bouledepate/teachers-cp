...
?>
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <h6>Не могу добавить дисциплину</h6>
            ...
            <h6>Забыл какие дисциплины уже закреплены в расписании</h6>
            <p>По форме ниже вы можете посмотреть какие дисциплины уже определены в расписании группы по конкретным
                дням.
                Иначе вернитесь по <a href="<?= Url::to(['schedule/view', 'id' => $group->id, 'week' => $weekId]) ?>">данной
                    ссылке</a> к полному расписанию.</p>
        </div>
    </div>
    <hr class="my-3">
